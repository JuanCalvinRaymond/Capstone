...
/*
Description: A score modifier to check if weapon is shot behind player and inside Tinnitus box
Creator: Juan Calvin Raymond
Creation Date: 22 Jan 2016
*/
public class CTrickTinnitus : ATrickScoreModifiers
{
    ...
    */
    ...
    {
        base.Awake();
        m_trickName = "Tinnitus";
        m_playerScale = new Vector3(1, 1, 1);
    }

    /*
    Description: Check if weapon is shot behind player and inside Tinnitus box
            ...
            if (aWeaponDataToCheck[i].m_active)
            {
                ...
                if (aWeaponDataToCheck[i].m_timeRegisteredToTheList <= aTimeWhenShot)
                {
                    ...
                    if (weaponOffset.x < m_boxSize / 2 && weaponOffset.x > -m_boxSize / 2
                        && weaponOffset.y < m_boxSize / 2 && weaponOffset.y > -m_boxSize / 2
                        && weaponOffset.z > -m_boxSize && weaponOffset.z < 0.0f)
                    {
