...
/*
Description: Class that inherit from AComboTrick, it will check if both weapon performed same trick
Parameters: 
Creator: Juan Calvin Raymond
Creation Date: 26 Jan 2017
Extra Notes:
*/
public class CComboTrickSimonSays : AComboTrick
{
    ...
    */
    private void Awake()
    {
        m_trickName = "Simon Says";
    }

    /*
    Description: Check if both weapon performed same trick
    Creator: Juan Calvin Raymond
    Creation Date: 26 Jan 2017
    */
