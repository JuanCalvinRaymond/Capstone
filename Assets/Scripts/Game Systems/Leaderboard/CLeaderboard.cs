...
public class CLeaderboard : ICloneable
{
    ...
    public int PCurrentNumberEntries
    {
        get
        {
            ...
            if(m_currentLeaderboard!=null)
            {
                ...
                return m_currentLeaderboard.Count;
            }
    ...
    private void SetSortingDelegate(ELeaderboardSortingMethods aMethod)
    {
        switch (aMethod)
        {
            ...
            case ELeaderboardSortingMethods.LowestNumberOfTricks://Lowest number of tricks
                ...
                break;
            case ELeaderboardSortingMethods.HighestNumberOfCombos://Highest number of combos
                m_delegSorting = SortByHighestNumberOfCombos;
                break;
            case ELeaderboardSortingMethods.LowestNumberOfCombos://Lowest number of combos
                m_delegSorting = SortByLowestNumberOfCombos;
                break;
            default:
    ...
    */
    ...
    {
        return entryB.m_numberOfTricks.CompareTo(entryA.m_numberOfTricks);
    }
    ...
    */
    ...
    {
        return SortByHighestNumberOfCombos(entryB, entryA);
    }
