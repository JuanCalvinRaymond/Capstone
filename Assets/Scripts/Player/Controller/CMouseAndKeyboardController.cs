...
/*
Description:Class to get the input from a mouse and keyboard
Creator: Alvaro Chavez Mixco
Creation Date: Wednesday, October 19th, 2016
*/
public class CMouseAndKeyboardController : IController
{
    private CWeaponControlInput m_rightWeaponControl;
    private CWeaponControlInput m_leftWeaponControl;

    private SControlKeys m_mouseKeyboardControlKeys;
    ...
    /*
    Description:Create a Scontrol keys struct and set it to the default mouse and keyboard input strings
    Creator: Alvaro Chavez Mixco
    Creation Date: Wednesday, October 19th, 2016
    */
    public CMouseAndKeyboardController()
    {
        //Set the keys that will be used in the game
        m_mouseKeyboardControlKeys = new SControlKeys();
        m_mouseKeyboardControlKeys.SetDefaultMouseAndKeyboardInputStrings();

        //Create the weapons controls for each weapon
        m_rightWeaponControl = new CWeaponControlInput(EWeaponHand.RightHand, m_mouseKeyboardControlKeys.PRightWeaponKeys);
        m_leftWeaponControl = new CWeaponControlInput(EWeaponHand.LeftHand, m_mouseKeyboardControlKeys.PLeftWeaponKeys);
    ...
    */
    ...
    /*
    Description: Update the weapon controls and keep track onf controls in use
    Creator: Alvaro Chavez Mixco
    ...
    */
    ...
    /*
    Description:Return the move input from the keyboard button presses
    Creator: Alvaro Chavez Mixco
    Creation Date: Wednesday, October 19th, 2016
    */
    public Vector3 GetMoveInput()
    {
        return new Vector3(Input.GetAxis(m_mouseKeyboardControlKeys.PHorizontalMovementAxis),
            0.0f,
            Input.GetAxis(m_mouseKeyboardControlKeys.PVerticalMovementAxis));
    }

    /*
    Description:Return the look input from the mouse position
    Creator: Alvaro Chavez Mixco
    Creation Date: Wednesday, October 19th, 2016
    */
    public Vector3 GetLookInput()
    {
        return new Vector3(Input.GetAxis(m_mouseKeyboardControlKeys.PHorizontalLookAxis),
            Input.GetAxis(m_mouseKeyboardControlKeys.PVerticalLookAxis) * m_invertYAxisValue,//Invert the Y axis
            0.0f)
    ...
    */
    ...
    {
        return Input.GetButtonDown(m_mouseKeyboardControlKeys.PPause);
    }

    /*
    Description:Returns if the user pressed any key
    Parameters: bool aIgnoreMoveKeys - If the move keys should be ignored, when reading key presses
    Creator: Alvaro Chavez Mixco
