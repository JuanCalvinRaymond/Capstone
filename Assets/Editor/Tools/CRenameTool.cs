...
public class CRenameTool : EditorWindow
{
    ...
    //Conditions
    private bool m_renameSelection = false;
    ...
    private delegate int delegateSorting(GameObject objectA, GameObject objectB);
        ...
        else//If it will rename the children of an object
        {
            ...
            if (m_parentObjectToRename != null)
            {
                ...
                if (GUILayout.Button(M_BUTTON_RENAME))
                {
                    ...
                    ReorderObjects(CUtilityGame.GetChildrenGameObjectFromParent(m_parentObjectToRename));
                }
            }
        }
    }
    ...
    */
    private void DisplayOrderingAlphanumerically()
    {
        ...
        if (m_shouldReorderObjectsAlphanumerically == true)
        {
            ...
            {
                //Assign delegate
                m_delegSorting = CUtilitySorting.SortByAlphanumerically;
            }
            else//If it will reorder objects inverse alphanumerically
            {
                //Assign delegate
                m_delegSorting = CUtilitySorting.SortByInverseAlphanumerically;
            }
        }
    ...
    */
    private void RenameChildrenObjects()
    {
        ...
        RenameObjects(CUtilityGame.GetChildrenGameObjectFromParent(m_parentObjectToRename));
    }
